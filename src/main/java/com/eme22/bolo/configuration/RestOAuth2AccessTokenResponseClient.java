...
import static com.eme22.bolo.configuration.SecurityConfiguration.DISCORD_BOT_USER_AGENT;
...
public class RestOAuth2AccessTokenResponseClient implements OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest> {
	...
	static class AccessResponse {
		...
		public Set<String> getScopes() {
			return ObjectUtils.isEmpty(scope) ? Collections.emptySet() : Stream.of(scope.split("\\s+")).collect(Collectors.toSet());
		}
	}
}